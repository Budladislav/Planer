...
export const STARTER_REWARD_TEMPLATES: readonly RewardDefinitionInput[] = [
  { starterTemplateId: 'song', title: 'Одна выбранная песня', cost: 2, grade: 'common', limitCount: 3, limitWindowValue: 1 },
  { starterTemplateId: 'clip', title: 'Один музыкальный клип', cost: 5, grade: 'common', limitCount: 2, limitWindowValue: 1 },
  { starterTemplateId: 'sweet', title: 'Шоколад или конфета', cost: 5, grade: 'common' },
  { starterTemplateId: 'game-30', title: 'Игра — 30 минут', cost: 6, grade: 'common', limitCount: 3, limitWindowValue: 7 },

  { starterTemplateId: 'game-60', title: 'Игра — 60 минут', cost: 11, grade: 'uncommon', limitCount: 3, limitWindowValue: 7 },
  { starterTemplateId: 'car-music', title: 'Музыка в машине до конца дня', cost: 20, grade: 'uncommon', cooldownValue: 1, limitCount: 3, limitWindowValue: 7 },
  ...
  { starterTemplateId: 'game-120', title: 'Игра — 120 минут', cost: 18, grade: 'rare', limitCount: 3, limitWindowValue: 7 },
  { starterTemplateId: 'cafe', title: 'Кафе', cost: 10, variableCost: true, grade: 'rare', cooldownValue: 3, limitCount: 4, limitWindowValue: 30 },
  { starterTemplateId: 'cinema', title: 'Кинотеатр', cost: 15, variableCost: true, grade: 'rare', cooldownValue: 7, limitCount: 2, limitWindowValue: 30 },
  { starterTemplateId: 'manicure', title: 'Маникюр в салоне', cost: 30, variableCost: true, grade: 'rare', cooldownValue: 21, limitCount: 2, limitWindowValue: 60 },
  ...
  { starterTemplateId: 'medium-purchase', title: 'Необязательная покупка среднего размера', cost: 100, variableCost: true, grade: 'legendary', cooldownValue: 30, limitCount: 1, limitWindowValue: 60 },
  { starterTemplateId: 'premium-upgrade', title: 'Премиальная версия заметной покупки', cost: 50, variableCost: true, grade: 'legendary' },

  { starterTemplateId: 'electronics', title: 'Ноутбук или электроника', cost: 800, variableCost: true, grade: 'mythic', cooldownValue: 60, limitCount: 1, limitWindowValue: 60 },
  { starterTemplateId: 'large-purchase', title: 'Крупная необязательная покупка', cost: 500, variableCost: true, grade: 'mythic', cooldownValue: 60, limitCount: 1, limitWindowValue: 60 },
  { starterTemplateId: 'major-hobby', title: 'Большой апгрейд для хобби', cost: 300, variableCost: true, grade: 'mythic', cooldownValue: 30, limitCount: 1, limitWindowValue: 60 },
] as const;
