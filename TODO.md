...
- **Упрощение чекбокса лягушки**:
  - Сделать чекбокс `🐸` в Inbox таким же, как в остальных вьюхах (минималистичный: без текста, только иконка и чекбокс).
  - Аналогично привести чекбокс в режиме редактирования задач в `Done`, чтобы все формы выглядели одинаково.
